...
EXPR = ROOT / "data/processed/DS001_GSE38900/analysis_ready/GPL6884_gene_expression.tsv.gz"
NET = ROOT / "results/regulatory_driver_analysis/design/COLLECTRI_HUMAN_FROZEN_v1.0.tsv.gz"
COV = ROOT / "results/regulatory_driver_analysis/qc/GPL6884_COLLECTRI_TARGET_COVERAGE_v1.0.tsv"

OUT = ROOT / "results/regulatory_driver_analysis/bulk"
...
if expr["gene_symbol"].duplicated().any():
    raise ValueError("Duplicate gene symbols detected in GPL6884 matrix.")
...
expected_tfs = set(
    cov.loc[cov["eligible_min5"], "source"].astype(str)
)
...
score_file = OUT / "GPL6884_COLLECTRI_ULM_ACTIVITY_MIN5_v1.0.tsv.gz"
padj_file = OUT / "GPL6884_COLLECTRI_ULM_PADJ_MIN5_v1.0.tsv.gz"
qc_file = QC / "GPL6884_COLLECTRI_ULM_INFERENCE_QC_v1.0.tsv"
...
print(padj_file)
print(qc_file)
print("\nGPL6884 ULM INFERENCE COMPLETE.")
