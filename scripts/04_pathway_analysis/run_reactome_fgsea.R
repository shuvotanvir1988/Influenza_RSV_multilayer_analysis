...
# ============================================================
# SESSION 17 — REACTOME PRERANKED ENRICHMENT
# ============================================================
...
cat("============================================================\n")
cat("SESSION 17 — REACTOME PRERANKED ENRICHMENT\n")
cat("============================================================\n")
...
if (!file.exists(geneset_file)) {
  stop(
    "Frozen Reactome gene-set file not found:\n",
    geneset_file
  )
}
...
# ============================================================
# Load frozen Reactome gene sets
# ============================================================
...
cat(
  "\nFrozen Reactome pathways loaded:",
  length(pathways),
  "\n"
)
...
for (contrast_name in names(rank_files)) {
  ...
  cat(
    "Reactome pathways passing size rule:",
...
summary_file <- file.path(
  outdir,
  "DS001_GSE38900_Reactome_fgsea_summary.tsv"
)
...
metadata_file <- file.path(
  outdir,
  "DS001_GSE38900_Reactome_fgsea_parameters.tsv"
)
...
cat("\n============================================================\n")
cat("SESSION 17 REACTOME ENRICHMENT COMPLETE\n")
cat("============================================================\n")
